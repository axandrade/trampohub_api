...
public record PerfilResponse(TipoUsuario tipo, String nomeEmpresa, String cnpj, String foto, String username,
                              String email) {

    public static PerfilResponse de(Usuario usuario) {
        return new PerfilResponse(usuario.getTipo(), usuario.getNomeEmpresa(), usuario.getCnpj(), usuario.getFoto(),
